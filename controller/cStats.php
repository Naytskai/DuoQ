        ...
        if (empty($matchesArray)) {
            ...
            for ($indexMatches = 0; $indexMatches < count($matchesArray); $indexMatches++) {
                ...
                if ($matchesArray[$indexMatches]['resultMatch'] == 1) {
                    $label = '<div class="row"><div class="col-md-6"><span class="label label-success">Win ' . $gameDate . '</span>';
                } else {
                ...
                $label = $label . '</div> <div id="shareGameLabel" class="col-md-6" onmouseover="$(\'#shareGameLabel\').tooltip(\'show\');" data-toggle="tooltip" title="Share this link with your friends"><span class="label label-default">http://cypressxt.net/DuoQ/index.php?l=sharing&matchId=' . $matchesArray[$indexMatches]['pkMatch'] . '</span></div></div>';
